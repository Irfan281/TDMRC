...
class PetaItem(private val peta: PetaResponseItem, val lat: Double, val long: Double) : com.xwray.groupie.viewbinding.BindableItem<ItemLokasiBinding>(){
    override fun bind(viewBinding: ItemLokasiBinding, position: Int) {
        ...
        viewBinding.apply {
            ...
            tvJarak.text = String.format("%.2f", (results[0]/1000)) + " km"
        }
    }
